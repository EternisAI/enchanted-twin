...
var extractFactsTool = openai.ChatCompletionFunctionTool(openai.FunctionDefinitionParam{
	Name: "EXTRACT_FACTS",
...
var consolidateMemoriesTool = openai.ChatCompletionFunctionTool(openai.FunctionDefinitionParam{
