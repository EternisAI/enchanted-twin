			...
			Parameters: openai.FunctionParameters{
				...
				"properties": map[string]any{
					...
					"task": map[string]string{
						"type":        "string",
						"description": "The task that agent should execute. It should contain all information nescessary to accomplish the task. Task must not include cron, delay or name of your human.",
					},
