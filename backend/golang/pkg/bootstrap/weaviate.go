...
func BootstrapWeaviateServer(ctx context.Context, logger *log.Logger, port string, dataPath string) (*rest.Server, error) {
	...
	_ = os.Setenv("LOG_LEVEL", "warn") // Reduce log noise for tests
...
func InitSchema(client *weaviate.Client, logger *log.Logger, embedding ai.Embedding, embeddingsModel string) error {
