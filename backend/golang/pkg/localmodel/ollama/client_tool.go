...
// var userPrompt = `[BEGIN OF TASK INSTRUCTION]
...
// [BEGIN OF QUERY]{query}[END OF QUERY]`
...
// 			c.logger.Warn("Anonymization deserialization failed", "attempt", attempt, "error", "no tool calls found in response")
// 			continue
// 		}
