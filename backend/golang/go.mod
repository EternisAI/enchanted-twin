...
require (
	...
	github.com/tinfoilsh/tinfoil-go v0.0.3
...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20250508185030-e625ff3534f1 // indirect
	...
	github.com/tinfoilsh/verifier v0.1.4 // indirect
