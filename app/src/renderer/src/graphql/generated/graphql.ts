...
export type Mutation = {
  ...
  startOAuthFlow: Scalars['String']['output'];
...
export type StartOAuthFlowMutation = { __typename?: 'Mutation', startOAuthFlow: string };
