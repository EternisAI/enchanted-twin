...
export type MessageStreamSubscription = { __typename?: 'Subscription', messageStream: { __typename?: 'MessageStreamPayload', messageId: string, chunk: string, role: Role, isComplete: boolean, createdAt?: any | null } };
