...
export type GetAgentTasksQuery = { __typename?: 'Query', getAgentTasks: Array<{ __typename?: 'AgentTask', id: string, name: string, schedule: string, plan?: string | null, createdAt: any, updatedAt: any }> };
