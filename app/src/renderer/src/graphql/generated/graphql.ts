...
export type IndexingStatusSubscription = { __typename?: 'Subscription', indexingStatus: { __typename?: 'IndexingStatus', status: IndexingState, processingDataProgress: number, indexingDataProgress: number, dataSources: Array<{ __typename?: 'DataSource', id: string, name: string, isProcessed: boolean, isIndexed: boolean, hasError: boolean }> } };
