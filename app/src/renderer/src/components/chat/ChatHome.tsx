      ...
      <div className="flex flex-col flex-1 min-h-full w-full justify-between">
        ...
        >
          ...
          <h5 className="text-gray-500 text-md">
            ...
            <span style={{ fontWeight: 500 }}>{twinName}</span>
          </h5>
          <div className="py-8">
          ...
          <div className="flex gap-10 p-4 border border-gray-200 rounded-lg">
            <div className="flex flex-col gap-2">
              <span>Today&apos;s Highlight</span>
              <span className="text-gray-500 text-sm">10 Messages</span>
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="text-gray-500 text-sm">Go Walk</span>
            </div>
          </div>
        </div>
        <div
