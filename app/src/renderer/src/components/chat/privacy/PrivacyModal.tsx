  ...
  return (
    <div className="flex flex-col w-full max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between p-6 border-b">
        <h1 className="text-2xl font-semibold">Privacy-preserving AI interface</h1>
        ...
        <div className="w-full">
          <div className="flex flex-col gap-4 prose prose-gray dark:prose-invert max-w-none pb-6">
            <p className="text-base leading-relaxed">
              ...
              life. Even with encryption in transit, your data still reaches the model
              provider&apos;s servers where it could potentially be logged, analyzed, or exposed in
              a breach.
            </p>
            <h2 className="text-2xl font-semibold mt-2">Why not just use TEEs?</h2>
            <p className="text-base leading-relaxed mb-2">
              You might wonder: why not run these models inside Trusted Execution Environments
              (TEEs) with hardware-level privacy guarantees? While we can and do serve open-source
              models from GPU-enabled TEEs, this approach hits fundamental limitations:
            </p>
            <ul className="list-disc list-inside space-y-3">
              <li className="text-base">
                The best models are closed-source: Claude, GPT-4, and other leading models
                aren&apos;t available for self-hosting
              </li>
              <li className="text-base">
                Hardware constraints: Modern language models are massive, a single H100 GPU
                can&apos;t host all 671B parameters of the best open source model (currently,
                DeepSeek R1), and confidential compute with PCIe bus encryption only works within a
                single GPU.
              </li>
              <li className="text-base">
            ...
            <p className="text-base leading-relaxed mb-2">
              ...
              You can run smaller, less capable models locally or in TEEs for privacy, or you can
              use powerful closed-source models and accept the privacy trade-offs. We believe you
            ...
            <ul className="list-decimal list-inside space-y-3">
              <li className="text-base">
                <strong>Local identification:</strong> A small models running entirely on your
                device identifies private information in your query
              </li>
              <li className="text-base">
              ...
              <li className="text-base">
                <strong>Automatic restoration:</strong> When the response comes back, we
                automatically restore your original information
              </li>
            </ul>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-muted/30 rounded-lg p-4 border-l-4 border-primary">
                ...
                <p className="text-base">
                  &quot;I&apos;m considering becoming a whistleblower to the SEC about financial
                  fraud at my tech company - could this affect my H1-B visa status?&quot;
                </p>
              </div>
              ...
              <div className="bg-muted/30 rounded-lg p-4 border-l-4 border-primary">
                ...
                <p className="text-base">
                  &quot;My skip-level is Jennifer who reports directly to Marc - should I talk to
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-muted/30 rounded-lg p-4 border-l-4 border-primary">
                <p className="text-sm font-medium text-muted-foreground mb-2">Query 1:</p>
                <p className="text-base">
                  &quot;I discovered my manager at TechCorp is systematically inflating sales
                  numbers for the enterprise software division&quot;
                </p>
              </div>
            ...
            <p className="text-base leading-relaxed mb-2">
              Connected together, these queries would let Google instantly identify the
              whistleblower - there&apos;s probably only one H1-B employee in cloud infrastructure
              whose skip-level is Jennifer reporting to Larry. But as three anonymous queries from
              different &quot;people,&quot; you get solid legal advice while staying completely
              protected. The model provider doesn&apos;t know these queries are related, but still
              provides help.
            </p>
            ...
            <ul className="list-disc list-inside space-y-3">
              <li className="text-base">
                <strong>Personal names</strong> are replaced with culturally and contextually
              ...
              <li className="text-base">
                <strong>Dates and times</strong> are shifted consistently to preserve relative
                timing
              </li>
              <li className="text-base">
            ...
            <ul className="list-decimal list-inside space-y-3">
              ...
              <li className="text-base">
                <strong>TEE proxies:</strong> Optional routing through Trusted Execution
                Environments that cryptographically guarantee they don&apos;t log or store your
                queries
              </li>
              <li className="text-base">
            ...
            <ul className="list-disc list-inside space-y-3">
              ...
              <li className="text-base">
                <strong>Writing patterns:</strong> Network routing prevents behavioral
                fingerprinting
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-3">
              <li className="text-base">
                <strong>General topics:</strong> The LLM still knows you&apos;re asking about
                meeting preparation, coding, or whatever your query concerns
              </li>
              <li className="text-base">
            ...
            <p className="text-base leading-relaxed mb-2">
              Our goal is to build this system and only add minimal overhead to your LLM
              interactions:
            </p>

            <ul className="list-disc list-inside space-y-3">
              <li className="text-base">
                <strong>Latency:</strong> Less than 500ms added to query time (targeting sub-100ms
                in future versions)
              </li>
              <li className="text-base">
            ...
            <ul className="list-disc list-inside space-y-3">
              <li className="text-base">
                <strong>Network strength:</strong> Privacy routing requires building either a
                network of relay nodes with similar availability to the Tor network or replicate it
                with trusted execution environments that adds a hardware trust assumption
              </li>
              <li className="text-base">
                <strong>Trust boundaries:</strong> You&apos;re still trusting our local
                anonymization model and routing infrastructure
              </li>
              <li className="text-base">
